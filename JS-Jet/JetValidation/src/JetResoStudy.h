...
class JetValidation : public SubsysReco
{
 public:
  ...
  TH1F* hDeltaR;              // Histogram for Delta R
  TH1F* hRecoJetPt;           // Histogram for reco jet pT
  TH1F* hTruthJetPt;          // Histogram for truth jet pT
  TH1F* hFakeJetPt;           // Histogram for fake jet pT (unmatched)
   ...
   doUnsub(int flag)
 {
  ...
  // New method for calculating Delta R
