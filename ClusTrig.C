...
void ClusTrig(std::string outFile="./trigEmulator_run_49270.root"){
  ...
  for (int i = 0; i <= 292; ++i) {
    fileList.push_back(Form("/sphenix/tg/tg01/jets/jamesj3j3/run49270/extracted_tree_49270_%d.root", i));
  }

  // Create a TChain to handle multiple input files
  TChain *ttree = new TChain("ttree_49270");  // Replace "ttree" with the actual name of your tree

  // Add files to the chain
  for (const auto& fileName : fileList) {
    ttree->Add(fileName.c_str());
  }
  ...
  TCanvas *c1 = new TCanvas("Trigger Clusters 1","Trigger Clusters 1 Run 49270");
  TCanvas *c2 = new TCanvas("Trigger Clusters 2","Trigger Clusters 2 Run 49270");
  TCanvas *c3 = new TCanvas("Trigger Clusters 3","Trigger Clusters 3 Run 49270");
  TCanvas *c4 = new TCanvas("Trigger Clusters Phi 1","Trigger Clusters Phi 1 Run 49270");  
  TCanvas *c5 = new TCanvas("Trigger Clusters Phi 2","Trigger Clusters Phi 2 Run 49270");
  TCanvas *c6 = new TCanvas("Trigger Clusters Phi 3","Trigger Clusters Phi 3 Run 49270");
  TCanvas *c7 = new TCanvas("Trigger Clusters Eta 1","Trigger Clusters Eta 1 Run 49270");
  TCanvas *c8 = new TCanvas("Trigger Clusters Eta 2","Trigger Clusters Eta 2 Run 49270");
  TCanvas *c9 = new TCanvas("Trigger Clusters Eta 3","Trigger Clusters Eta 3 Run 49270");
...
// Defining the Histogram, setting number of bins for x and y axes                                                                                                                         
  ...
  TH2D *TowerJetTrigger17 = new TH2D("TowerJetTrigger17","Tower Jet 2 (8 GeV) Trigger 17 Run 49270",96,0,96,256,0,256);
  TH2D *TowerJetTrigger18 = new TH2D("TowerJetTrigger18","Tower Jet 3 (10 GeV) Trigger 18 Run 49270",96,0,96,256,0,256);
  TH2D *TowerJetTrigger19 = new TH2D("TowerJetTrigger19","Tower Jet 4 (12 GeV) Trigger 19 Run 49270",96,0,96,256,0,256);
  TH1F *TowerJetTriggerPhi17 = new TH1F("TowerJetTriggerPhi17","Tower Jet 2 in Phi (8 GeV) Trigger 17 Run 49270",256,0,256);
  TH1F *TowerJetTriggerPhi18 = new TH1F("TowerJetTriggerPhi18","Tower Jet 3 in Phi (10 GeV) Trigger 18 Run 49270",256,0,256);
  TH1F *TowerJetTriggerPhi19 = new TH1F("TowerJetTriggerPhi19","Tower Jet 4 in Phi (12 GeV) Trigger 19 Run 49270",256,0,256);
  TH1F *TowerJetTriggerEta17 = new TH1F("TowerJetTriggerEta17","Tower Jet 2 in Eta (8 GeV) Trigger 17 Run 49270",96,0,96);
  TH1F *TowerJetTriggerEta18 = new TH1F("TowerJetTriggerEta18","Tower Jet 3 in Eta (10 GeV) Trigger 18 Run 49270",96,0,96);
  TH1F *TowerJetTriggerEta19 = new TH1F("TowerJetTriggerEta19","Tower Jet 4 in Eta (12 GeV) Trigger 19 Run 49270",96,0,96);
  ...
  c1->SaveAs("TowerJetTrigger17_49270.png");
  ...
  c2->SaveAs("TowerJetTrigger18_49270.png");
  ...
  c3->SaveAs("TowerJetTrigger19_49270.png");
  ...
  // Save the canvas
  c4->SaveAs("TowerJetTriggerPhi17_49270w.png");
  ...
  c5->SaveAs("TowerJetTriggerPhi18_49270w.png");
  ...
  c6->SaveAs("TowerJetTriggerPhi19_49270w.png");
  ...
  c7->SaveAs("TowerJetTriggerEta17_49270w.png");
  ...
  c8->SaveAs("TowerJetTriggerEta18_49270w.png");
  ...
  c9->SaveAs("TowerJetTriggerEta19_49270w.png");
